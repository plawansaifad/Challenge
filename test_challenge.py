...
# Case 1
UnitPriceTHB = tracksOutput.dtypes['UnitPriceTHB']
if UnitPriceTHB == 'int64':
    f.write("Case 1: Pass\n")
else:
    f.write("Case 1: Fail\n")
...
if (mergedTracks['UnitPriceTHB'] - mergedTracks['UnitPrice_input'] >= 33.77).all():
    f.write("Case 2: Pass\n")
else:
    f.write("Case 2: Fail\n")
...
with  open(testResultPath, "r") as f_read:
  for line in f_read:
    print(line)
